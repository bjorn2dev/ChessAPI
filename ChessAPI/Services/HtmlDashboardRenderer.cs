...
document.querySelectorAll("".selection"").forEach(function (element) {
 ...
 function startNewGame(color) {
    alert(`Starting a new game as ${color}`);
    // Add your logic here to start a game with the selected color.
}

function startOnlineGame() {
    alert('Starting a new online game');
    // Add your logic here for the online game.
}

function startCouchCoop() {
    alert('Starting a new couch co-op game');
    // Add your logic here for couch co-op.
}
</script>
";
